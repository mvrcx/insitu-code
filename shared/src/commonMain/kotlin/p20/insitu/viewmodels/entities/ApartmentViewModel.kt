...
class ApartmentViewModel(
    ...
    override fun createNewEntity(): Apartment {
        return ObjectFactory.createApartment()
    }

    override fun updateUiStates(entity: Apartment) {
    ...
    override fun getEditedEntityState(): Apartment {
        return Apartment().also {
            it.designation = designation.value
            it.thumbnailId = thumbnailId.value
            it.locationType = locationType.value
            it.docNumber = docNumber.value
