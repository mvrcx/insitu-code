...
data class WeaponSystem(
    ...
    override var type: CatalogCodeFixed<KatalogCode297>?,
...
) : BaseEntity(), Evidence, XpWeaponSystem {

    override val entityType: String = EntityType.WEAPON_SYSTEM.toString()

    override fun getWaffensystem(): Waffensystem {
        return Waffensystem().also {
