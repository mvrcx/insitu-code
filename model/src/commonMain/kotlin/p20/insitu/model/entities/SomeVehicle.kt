...
) : BaseEntity(), Site, Evidence, XpSomeVehicle {

    override val entityType: String = EntityType.SOME_VEHICLE.toString()

    override fun getSonstigesFahrzeug(): SonstigesFahrzeug {
        return SonstigesFahrzeug().also {
