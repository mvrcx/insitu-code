...
data class PortableObject(
    ...
    override var type: CatalogCodeFixed<KatalogCode293>?,
    ...
    ) : BaseEntity(), Evidence, XpPortableObject {

    override val entityType: String = EntityType.PORTABLE_OBJECT.toString()

    override fun getTragbarerGegenstand(): TragbarerGegenstand {
        return TragbarerGegenstand().also {
