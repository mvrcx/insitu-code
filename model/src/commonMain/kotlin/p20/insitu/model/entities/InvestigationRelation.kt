...
@Serializable
data class InvestigationRelation(
    override var deleted: Boolean = false,
    override var sourceId: String,
    override var sourceType: String,
    override var targetId: String,
    override var targetType: String = EntityType.INVESTIGATION.toString(),
    ...
    override val entityType: String = EntityType.INVESTIGATION_RELATION.toString()
