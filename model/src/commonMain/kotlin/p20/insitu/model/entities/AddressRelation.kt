...
/**
 * This class describes the relation between a [Location] and an [Address].
 *
 * @property deleted
 * @property sourceId
 * @property sourceType
 ...
 * @property comment
 * @constructor Create empty Address relation
 */
@Serializable
data class AddressRelation(
    override var deleted: Boolean = false,
    override var sourceId: String,
    override var sourceType: String = EntityType.ADDRESS.toString(),
    ...
    override val entityType: String = EntityType.ADDRESS_RELATION.toString()
