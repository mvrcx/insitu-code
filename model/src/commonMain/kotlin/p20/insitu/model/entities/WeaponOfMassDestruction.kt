...
@Serializable
data class WeaponOfMassDestruction(
    ...
    override var type: CatalogCodeFixed<KatalogCode299>?,
...
) : BaseEntity(), Evidence, XpWeaponOfMassDestruction {

    override val entityType: String = EntityType.WEAPON_OF_MASS_DESTRUCTION.toString()

    override fun getMassenvernichtungswaffe(): Massenvernichtungswaffe {
        return Massenvernichtungswaffe().also {
