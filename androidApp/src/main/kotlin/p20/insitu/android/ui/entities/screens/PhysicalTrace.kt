...
import p20.insitu.android.ui.entities.tabs.PhysicalTraceTabs
...
fun PhysicalTrace(
    ...
    viewModel: PhysicalTraceViewModel = get(),
    ...
    Scaffold(
        topBar = {
            TopAppBars.BaseEntityDetails(
                ...
                title = EntityTypeStrings.physicalTrace(language.value),
                sessionHandler = get(),
                uiStateHandler = get(),
                viewModel = viewModel,
