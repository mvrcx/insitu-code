...
import p20.insitu.android.ui.entities.tabs.SomeSiteDetails
import p20.insitu.android.ui.entities.tabs.SomeSiteTabs
...
fun SomeSite(
    ...
    viewModel: SomeSiteViewModel = get(),
    ...
    Scaffold(
        topBar = {
            TopAppBars.BaseEntityDetails(
                ...
                title = EntityTypeStrings.someSite(language.value),
                sessionHandler = get(),
                uiStateHandler = get(),
                viewModel = viewModel,
