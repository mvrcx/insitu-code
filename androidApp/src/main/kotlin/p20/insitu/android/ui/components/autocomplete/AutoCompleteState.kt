...
class AutoCompleteState<T : AutoCompleteEntity>(private var startItems: List<T>) :
    AutoCompleteScope<T> {
    ...
    override var boxWidthPercentage by mutableStateOf(1.0f)
    ...
    override var boxShape: Shape by mutableStateOf(RectangleShape)
