...
import p20.insitu.viewmodels.entities.ApartmentViewModel
import p20.insitu.android.ui.components.TopAppBars
import p20.insitu.android.ui.components.buttons.Buttons
import p20.insitu.android.ui.entities.tabs.ApartmentTabs
    ...
    Scaffold(
        topBar = {
            TopAppBars.BaseEntityDetails(
                ...
                title = EntityTypeStrings.floor(language.value),
                sessionHandler = get(),
                uiStateHandler = get(),
                viewModel = viewModel,
