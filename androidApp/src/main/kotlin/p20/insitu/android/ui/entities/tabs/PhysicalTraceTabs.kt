...
fun PhysicalTraceTabs(
    ...
    if (docuMode.value && !entityCreation) {
        (docuObject.value as? PhysicalTrace)?.let { docuObject ->
            // Init view model
    ...
    // Entity
    val physicalTrace = viewModel.entity.collectAsState()
