...
import p20.insitu.android.ui.entities.tabs.DNATraceTabs
...
fun DNATrace(
    ...
    viewModel: DNATraceViewModel = get(),
    ...
    Scaffold(
        topBar = {
            TopAppBars.BaseEntityDetails(
                ...
                title = EntityTypeStrings.typeString(EntityType.PHYSICAL_TRACE, language.value),
                sessionHandler = get(),
                uiStateHandler = get(),
                viewModel = viewModel,
